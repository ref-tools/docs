---
title: "Case Studies"
description: "Real-world examples of using Ref to enhance AI-driven software development."
---

<CardGroup cols={2}>
  <Card
    title="Migrate from Firestore to Turbopuffer"
    icon="database"
    href="https://ref.tools/use-case/turbopuffer"
  >
  ...
  <Card
    title="Text-to-speech MCP server with Rime"
    icon="microphone"
    href="https://ref.tools/use-case/rime"
  >
