...
These tools cover reading, searching, commenting on, creating, reviewing, and merging issues and pull requests. They require:
...
See the [GitHub integration page](/plans/integrations/github) for the full tool list and the permissions that control which of them agents get.
