...
Each entry in the menu shows the check's name, what it looks for, and a tag saying what it will do to your plan. Choosing one starts its own chat thread, named after the check, and the agent reads the current plan before doing anything else.
