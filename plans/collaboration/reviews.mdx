...
Feedback that is quicker to draw than to write can go through [markup mode](/plans/collaboration/markup), which turns annotations on the rendered plan into edits an agent applies.
