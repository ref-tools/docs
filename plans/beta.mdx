...
Ref Plans is a tool for iterating and collaborating on plans for coding agents. 

You can research, revise and share with other humans for feedback. When a plan is ready, send it to your coding agent of choice (Claude Code, Cursor, Codex, Conductor etc) to implement and that agent will report progress back to Ref.
