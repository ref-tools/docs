...
3. Visit https://plan.ref.tools and start your first plan!
...
- **Write and iterate on long-lived AI plans that span multiple code changes** - The */plan* modes in tools like Claude or Cursor are great for individual code changes. However, they are ephemeral. Commonly I'm building a feature that should be broken down to multiple code changes and I want to write and review one cohesive plan.
...
### Index your codebase with Ref and do research in the web client
