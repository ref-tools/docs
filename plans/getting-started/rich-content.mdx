...
Images you upload, whether from the editor or through the MCP server, count against your media storage limit. The Free tier includes 1 GB; see [Pricing](/usage/pricing) for the limit on each tier.
