...
The same markdown renders as an alert on GitHub and as a callout in Obsidian, so a plan that uses callouts stays readable when you paste it into a pull request or an Obsidian vault.
