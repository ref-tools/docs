...
<Steps>
  ...
  <Step title="Ship it">
    ...
    When a task finishes, a PR appears directly in your plan. You can provide higher-level feedback as work progresses, or launch [Orchestrate](/plans/workflows/orchestrate) to let Ref run the agents, review their PRs against the plan, and — if you grant the permission — merge them.
