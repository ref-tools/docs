    ...
    <Tabs>
      ...
      <Tab title="Claude Code, Codex, and more">
        **1. No API key needed**
        ...
        Supported launchers include Claude Code (Web and Desktop), Codex (Cloud and Desktop), and Cursor Desktop, plus a plain copy to clipboard for any other agent. The [integrations overview](/plans/integrations/overview) lists them all.
