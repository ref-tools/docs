...
2. **API keys configured** for Cursor, Devin, Warp OZ, and/or Conductor Cloud in [Agent Settings](https://plan.ref.tools/settings) — required for the `cursor`, `devin`, `warp-oz`, and `conductor-cloud` harnesses
