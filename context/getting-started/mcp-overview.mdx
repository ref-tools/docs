---
title: "What is MCP?"
description: "Understanding the Model Context Protocol and why it matters for AI coding agents."
---
...
<Columns cols={2}>
<Card icon="rocket" title="Try Ref" href="/context/getting-started/quick-start">
Install the Ref MCP server and see it in action.
</Card>
<Card icon="book" title="MCP Server Details" href="/context/mcp/tools">
